...
public class VizbeeNativeManager extends ReactContextBaseJavaModule implements LifecycleEventListener, VizbeeEventHandler {
    ...
    public void smartPlay(ReadableMap vizbeeVideoMap,
        ...
        Log.v(LOG_TAG, "Invoking smartPlay with options: " + smartPlayOptionsMap);
        ...
        // Check if smartPlayOptions is provided
        if (null != smartPlayOptionsMap) {
            // Create SmartPlayOptions from the provided map
    ...
    private SmartPlayOptions getSmartPlayOptions(ReadableMap smartPlayOptionsMap) {
        SmartPlayOptions options = new SmartPlayOptions();
    ...
    public void removeUICardConfiguration(String cardType) {
        ...
        UICardType uiCardType = getCardType(cardType);
        if (null == uiCardType) {
